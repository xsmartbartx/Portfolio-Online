...
const Hero = () => {
  ...
  return (
    <section id="home" ref={heroRef} className="section overflow-hidden flex flex-col justify-center items-center pt-28 md:pt-32">
      {/* Background elements */}
      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-block mb-6 px-4 py-1.5 rounded-full border border-accent border-opacity-30 text-sm text-secondary backdrop-blur-sm bg-tertiary bg-opacity-20 shadow-glow"
          >
