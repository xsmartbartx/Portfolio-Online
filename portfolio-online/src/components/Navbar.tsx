...
const Navbar = () => {
  ...
  return (
    <nav 
      className={`w-full px-6 py-5 fixed top-0 z-30 transition-all duration-300 ${
        scrolled 
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="fixed top-0 right-0 w-full max-w-sm h-screen glass-card border-l border-white-100 border-opacity-10 shadow-xl z-10"
            >
